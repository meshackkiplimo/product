...
const AdminDrawer = () => {
    ...
    const isActivePath = (path: string) => {
        return location.pathname === path || (path !== '/admin-dashboard' && location.pathname.includes(path));
    };
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl p-3 border border-blue-500/20">
                        <div className="text-xs text-blue-400 font-medium">Total Products</div>
                        <div className="text-lg font-bold text-white">24</div>
                    </div>
                    <div className="bg-gradient-to-br from-green-500/10 to-green-600/10 rounded-xl p-3 border border-green-500/20">
                        <div className="text-xs text-green-400 font-medium">Total Payments</div>
